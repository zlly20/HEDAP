...
from locator_w19 import heda_lex_locators
...
#sys.path.append("/Users/dshattuck/Documents/GitHub/CumulusCI/cumulusci/robotframework/tests")
#import Salesforce
...
class HEDA(object):
    ...
    def click_special_related_list_button(self, heading, button_title):
        ...
        """
        locator = heda_lex_locators['record']['related']['button'].format(heading, button_title)
        self.selenium.set_focus_to_element(locator)
    ...
    def change_month(self, value):    
        ...
        locator = heda_lex_locators['record']['month_pick'].format(value)
        self.selenium.set_focus_to_element(locator)
        self.selenium.get_webelement(locator).click()
...
#     def select_row(self,value):
#         """To select a row on object page based on name and open the dropdown"""    
#         locator = heda_lex_locators['select_name'].format(value)
#         self.selenium.set_focus_to_element(locator)
#         drop_down = heda_lex_locators['locating_delete_dropdown'].format(value)
#         time.sleep(1)
#         return drop_down
    ...
    def select_related_row(self, value):
        ...
        for index, element in enumerate(list_ele):
            if element.text == value:
                drop_down = heda_lex_locators['rel_loc_dd'].format(index + 1)
                self.selenium.get_webelement(drop_down).click()
                time.sleep(1)
#     def select_row(self, value ):
#         """To select a row on object page based on name and open the dropdown"""
...
#                 index = index+1
#             else:
#                 drop_down = heda_lex_locators['locate_dropdown'].format(index)
#                 self.selenium.get_webelement(drop_down).click()
#                 self.selenium.get_webelement(drop_down).click()
...
#                 self.selenium.get_webelement(drop_down).click()      
    ...
    def confirm_value(self, field,value,status):
        locator=heda_lex_locators['check_status'].format(field,value)
        if status.upper()=="Y":
...
#         return verify_former
    ...
    def click_span_button(self,title):  
        ...
        locator=heda_lex_locators['span_button'].format(title)
        self.selenium.get_webelement(locator).click()  
    ...
    def verify_header(self,value):   
        ...
        locator= heda_lex_locators['header'].format(value)
        self.selenium.page_should_contain_element(locator)    
    ...
    def Verify_affiliated_contact(self,list_name,first_name,last_name, y):   
        ...
        locator= heda_lex_locators['affiliated_contacts'].format(list_name,first_name,last_name)
        if y.upper()=="Y":
            self.selenium.page_should_contain_element(locator)
        elif y.upper()=="N":
            self.selenium.page_should_not_contain_element(locator)
    ...
    def fill_address_form(self, **kwargs):
        ...
        for label, value in kwargs.items():
            locator= heda_lex_locators['manage_hh_page']['address'].format(label,value)
            if label=="Street":
    ...
    def Verify_details_address(self,field,heda_street, heda_city, heda_country):   
        """Validates if the details page address field has specified value"""   
        locator= heda_lex_locators['detail_page']['address'].format(field)
        street, city, country = self.selenium.get_webelements(locator)
        if street.text ==  heda_street and city.text == heda_city and country.text == heda_country:
            return "pass"
        else:
            return "fail"
    ...
    def validate_checkbox(self,name,checkbox_title):   
        ...
        locator=heda_lex_locators['manage_hh_page']['mhh_checkbox'].format(name,"fauxCBInformal")
        self.selenium.page_should_contain_element(locator)
        
        locator=heda_lex_locators['manage_hh_page']['mhh_checkbox'].format(name,"fauxCBFormal")
        self.selenium.page_should_contain_element(locator)
        
        locator=heda_lex_locators['manage_hh_page']['mhh_checkbox'].format(name,"fauxCBExName") 
        self.selenium.page_should_contain_element(locator)
    ...
    def check_field_value(self, title, value):
        ...
        locator=heda_lex_locators['detail_page']['verify_field_value'].format(title,value)
        self.selenium.page_should_contain_element(locator)
    ...
    def click_managehh_link(self,title):  
        """clicks on the new contact button on manage hh page"""      
        locator=heda_lex_locators['manage_hh_page']['address_link'].format(title)
        self.selenium.get_webelement(locator).click()      
    
    def select_lightning_checkbox(self,title):
        """"""
        locator=heda_lex_locators['checkbox'].format(title)
        self.selenium.get_webelement(locator).click()
        
    def verify_occurance(self,title,value):
        """"""
        locator=heda_lex_locators['record']['related']['check_occurance'].format(title,value)
        self.selenium.page_should_contain_element(locator)    
    ...
    def click_special_object_button(self, title):
        locator = heda_lex_locators['object']['button'].format(title)
        self.selenium.get_webelement(locator).click()
        
    def click_eng_plan_dropdown(self, title):
        locator = heda_lex_locators['engagement_plan']['dropdown'].format(title)
        self.selenium.set_focus_to_element(locator)
        self.selenium.get_webelement(locator).click()
    ...
    def select_eng_plan_checkbox(self,title):
        ...
        if title=="Skip Weekends":
            locator=heda_lex_locators['engagement_plan']['checkbox'].format("span",title)
            self.selenium.get_webelement(locator).click()
        else:
            locator=heda_lex_locators['engagement_plan']['checkbox'].format("label",title)
            self.selenium.get_webelement(locator).click()
    ...
    def enter_eng_plan_values(self, **kwargs):
        ...
        for name, value in kwargs.items():
            if name == "Engagement Plan Template Name":
                id = "idName"
                locator = heda_lex_locators['id'].format(id) 
                self.selenium.get_webelement(locator).send_keys(value)     
    ...
    def enter_task_id_and_subject(self, id, value):
        ...
        locator = heda_lex_locators['engagement_plan']['input_box'].format(id) 
        self.selenium.get_webelement(locator).send_keys(value)
    ...
    def check_related_list_values(self,list_name,*args):
        ...
        for value in args:
            locator = heda_lex_locators['check_related_list_item'].format(list_name,value)
            self.selenium.page_should_contain_element(locator)
    ...
    def verify_eng_plan_exists(self,name, delete=None):  
        ...
        locator = heda_lex_locators['engagement_plan']['check_eng_plan'].format(name)
        self.selenium.page_should_contain_element(locator) 
        plan=self.selenium.get_webelement(locator).text   
        if delete == "True":
               locator = heda_lex_locators['engagement_plan']['dd'].format(name)
               self.selenium.get_webelement(locator).click()      
        return plan
    ...
    def check_activity_tasks(self, *args):
        ...
        for value in args:
            locator = heda_lex_locators['engagement_plan']['tasks'].format(value)
            self.selenium.page_should_contain_element(locator)
    ...
    def enter_level_values(self, **kwargs):
        ...
        for name, value in kwargs.items():
            if name == "Level Name":
                id = "fldName"
                locator = heda_lex_locators['levels']['id'].format(id)
                self.selenium.set_focus_to_element(locator)  
                self.selenium.get_webelement(locator).send_keys(value)      
    ...
    def enter_level_dd_values(self, name,value):
        ...
        if name == "Target":
            id = "fldTarget"
            locator = heda_lex_locators['levels']['select'].format(id)
    ...
    def select_app_launcher_link(self,title):
        locator = heda_lex_locators['app_launcher']['select-option'].format(title) 
        self.selenium.get_webelement(locator).click()
        time.sleep(1)
        
    def click_on_first_record(self):  
        """selects first record of the page"""
        locator = heda_lex_locators['select_one_record']
        self.selenium.get_webelement(locator).click()
        time.sleep(1)  
        
    def select_search(self, index, value):
        """"""
        locator = heda_lex_locators["click_search"].format(index)
    ...
    def enter_payment_schedule(self, *args):
        ...
        for i in range(len(args)):
            locator = heda_lex_locators['id'].format(id[i])
            loc = self.selenium.get_webelement(locator)
            self.selenium.set_focus_to_element(locator)       
    ...
    def verify_date_split(self,date, no_payments, interval): 
        ...
        locator = heda_lex_locators['payments']['date_loc'].format(date)
...
#            for i in range(int(no_payments) + 1):
        if mm <= 12:
            ...
            locator1 = heda_lex_locators['payments']['date_loc'].format(new_date)
...
#             return "fail"
    ...
    def click_viewall_related_list (self,title):  
        ...
        locator=heda_lex_locators['record']['related']['viewall'].format(title)
        self.selenium.get_webelement(locator).click()
        
    def click_button_with_value (self,title):  
        """clicks on the button on the payments page"""      
        locator=heda_lex_locators['button'].format(title)
        self.selenium.get_webelement(locator).click()
        
#         
#     def verify_payments(self, amount,no_payments):
#         """To select a row on object page based on name and open the dropdown"""
#         locators = heda_lex_locators['payments']['no_payments']
#         list_ele = self.selenium.get_webelements(locators)
#         t_count=len(list_ele)
#         for index, element in enumerate(list_ele):
#             if element.text == amount:
#                 loc = heda_lex_locators['payments']['pay_amount'].format(index + 1, amount)
#                 self.selenium.page_should_contain_element(loc)
#                 time.sleep(1)
                
    def verify_occurance_payments(self,title,value=None):
        """"""
        locator=heda_lex_locators['payments']['check_occurance'].format(title)
    ...
    def select_value_from_list(self,list_name,value): 
        locator = heda_lex_locators['heda_settings']['list'].format(list_name)
        loc = self.selenium.get_webelement(locator)
        self.selenium.set_focus_to_element(locator)       
        self.selenium.select_from_list_by_label(loc,value)   
    ...
    def get_heda_settings_value(self,field_name): 
        locator = heda_lex_locators['heda_settings']['field_value'].format(field_name)
        loc = self.selenium.get_webelement(locator).text  
        return loc 
    
    def click_panel_sub_link (self,title):  
        """clicks on the button on the payments page"""      
        locator=heda_lex_locators['heda_settings']['panel_sub_link'].format(title)
        self.selenium.get_webelement(locator).click()
    ...
    def page_scroll_to_locator(self, path, *args, **kwargs):
        loc=self.get_heda_locator(path, *args, **kwargs)
